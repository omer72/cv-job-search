...
const en = {
  ...
  upgradePdf: "Save as PDF",
  upgradePdfHint: "Opens your browser's print dialog — choose Save as PDF as the destination.",
...
const he: typeof en = {
  ...
  upgradePdf: "שמרו כ-PDF",
  upgradePdfHint: "נפתח חלון ההדפסה של הדפדפן — בחרו שמירה כ-PDF כיעד.",
  upgradeCopied: "הועתק",
