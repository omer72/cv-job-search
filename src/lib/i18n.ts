...
const en = {
  ...
  techmapTitle: "Every open tech job in Israel",
  techmapIntro:
    "A public feed of Israeli tech openings, refreshed daily. Pick the kinds of work you want and they get scored against your CV like any other role.",
  techmapPickTypes: "Kind of work",
  techmapQuery: "Words in the title, company or industry",
  techmapQueryPlaceholder: "backend, kubernetes, fintech",
  techmapCity: "City",
  techmapCityPlaceholder: "Tel Aviv, חיפה",
  techmapLevel: "Level",
  techmapAnyLevel: "Any level",
  techmapSearch: "Find and score these jobs",
  techmapSearching: "Fetching and scoring",
  techmapNone: "No openings matched those filters. Widen the kind of work, or clear the keywords.",
  techmapCredit: "Data: Israeli Tech Map by @mluggy, Open Database License.",
  techmapSelectOne: "Pick at least one kind of work.",
  techmapTypes: {
    software: "Software",
    frontend: "Frontend",
    ...
    support: "Support",
    admin: "Admin",
    "procurement-operations": "Procurement and operations",
  ...
  companyRoles: (n: number) => (n === 1 ? "1 role" : `${n} roles`),
...
const he: typeof en = {
  ...
  techmapTitle: "כל המשרות הפתוחות בהייטק הישראלי",
  techmapIntro:
    "פיד ציבורי של משרות בהייטק בישראל, מתעדכן כל יום. בחרו את סוגי העבודה שמעניינים אתכם והמשרות יקבלו ציון התאמה לקורות החיים שלכם, כמו כל משרה אחרת.",
  techmapPickTypes: "סוג העבודה",
  techmapQuery: "מילים בכותרת, בחברה או בתחום",
  techmapQueryPlaceholder: "בקאנד, kubernetes, פינטק",
  techmapCity: "עיר",
  techmapCityPlaceholder: "תל אביב, חיפה",
  techmapLevel: "רמה",
  techmapAnyLevel: "כל הרמות",
  techmapSearch: "מצאו ודרגו את המשרות",
  techmapSearching: "מביאים ומדרגים",
  techmapNone: "לא נמצאו משרות לפי הסינון. הרחיבו את סוגי העבודה, או נקו את מילות החיפוש.",
  techmapCredit: "מקור הנתונים: Israeli Tech Map מאת ‎@mluggy‎, ברישיון Open Database License.",
  techmapSelectOne: "בחרו לפחות סוג עבודה אחד.",
  techmapTypes: {
    ...
    support: "תמיכה",
    admin: "אדמיניסטרציה",
    "procurement-operations": "רכש ותפעול",
  },
  techmapLevels: {
    Engineer: "מהנדס/ת",
    Manager: "מנהל/ת",
    Architect: "ארכיטקט/ית",
    "Tech Lead": "טים ליד",
    Student: "סטודנט/ית",
    Executive: "בכיר/ה",
  },
  ...
  companyRoles: (n: number) => (n === 1 ? "משרה אחת" : `${n} משרות`),
